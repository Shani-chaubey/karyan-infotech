...
export default function ContactPageContent({ payload }: { payload: ContactPayload }) {
  return (
    <section style={{ background: "#fff" }} className="pt-4 pb-12">
      <div className="mx-auto max-w-[1200px] px-4">
        <div className="mb-10 text-center">
          <h2 className="mb-2 text-3xl font-bold leading-tight pt-4" style={{ color: "#292929" }}>
            Get in touch with our team
          </h2>
          <div
            className="mx-auto mt-3 h-0.5 w-10"
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          <div>
              ...
              {payload.contactItems.map((info) => {
                ...
                return (
                  <div key={info.label} className="flex items-start gap-4">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-sm bg-[linear-gradient(135deg,#a07c3a,#c6a96a)]">
            ...
            <div
              ...
              style={{ height: "220px", border: "1px solid #eee" }}
            >
              <iframe
